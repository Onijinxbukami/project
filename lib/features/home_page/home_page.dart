...
Widget build(BuildContext context) {
  return DefaultTabController(
    length: 4, // 🔥 Tăng số tab lên 4
    initialIndex: 1, // Tab mặc định là "SendMoneyForm()"
    child: Scaffold(
      ...
      body: TabBarView(
        children: [
          ...
          Padding(padding: const EdgeInsets.only(top: 0), child: SendMoneyForm()), // Tab mặc định
      ...
      bottomNavigationBar: Container(
        ...
        child: TabBar(
          ...
          tabs: [
            ...
            Tab(text: tr('send'), icon: const Icon(Icons.send)), // Tab mặc định
            Tab(text: tr('setting'), icon: const Icon(Icons.settings)),
            Tab(text: tr('history'), icon: const Icon(Icons.history)), // 🔥 Tab mới
          ],
        ),
      ),
    ),
